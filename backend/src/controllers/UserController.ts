...
export class UserController {
    ...
    public static async update(req: Request, res: Response): Promise<Response> {
        try {
            ...
            return res.status(500).json({ erro: 'Erro ao atualizar o usuário', detalhe: error.message });
        }
    }
    ...
    public static async delete(req: Request, res: Response): Promise<Response> {
        try {
            ...
            return res.status(500).json({ erro: 'Erro ao excluir o usuário', detalhe: error.message });
        }
    }
}